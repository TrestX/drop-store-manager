...
$(window).load(function () {
  //Preloader
  setTimeout(
    "$('#preloader').animate({'opacity' : '0'},300,function(){$('#preloader').hide()})",
    1000
  );
  setTimeout(
    "$('.preloader_hide, .selector_open').animate({'opacity' : '1'},500)",
    1000
  );
});
/*-----------------------------------------------------------------------------------*/
...
$(document).ready(function () {
  $(".menu_block .container").prepend(
    '<a class="menu_toggler"><i class="fa fa-align-justify"></i></a>'
  );
...
$(window).load(function () {
  (function () {
    ...
    $(document).on("click", "#tover_view_page_close, .close_block", function (
      event
    ) {
      $("#tovar_content").animate(
        {
