...
const DropdownComp = ({sv,sellers,setSellerID}:{sv:any,sellers:any,setSellerID:any}) => {
    ...
    return (
        <div className="dropdown-demo">
                <Dropdown value={selectedSeller} options={sellers.data} onChange={onSellerChange} optionLabel="email" filter showClear filterBy="email" placeholder={sv?sv:"Select a Seller"}
