...
let OrderCompCards: React.FunctionComponent<Props> = props => {

    const [showMap,setShowMap] = useState(false)
    useEffect(() => {
        const d={status:"Accepted",shopid:"",userid:"",deliveryId:""}
        props.fetchorders(d)
    }, [])
    const openMap=()=>{
        setShowMap(true)
...
export default OrderCompCards = connect(mapStateToProps, mapDispatchToProps)(OrderCompCards)
