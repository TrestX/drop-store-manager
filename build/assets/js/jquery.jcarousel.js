...
(function(t) {
  ...
  (i.parseTarget = function(t) {
    var i = !1,
      e = "object" != _typeof(t) ? s.exec(t) : null;
    return (
      e
        ? ((t = parseInt(e[2], 10) || 0),
          e[1] && ((i = !0), "-=" === e[1] && (t *= -1)))
        : "object" != _typeof(t) && (t = parseInt(t, 10) || 0),
      {
        target: t,
        relative: i
      }
    ...
    (i.base = function(s) {
      return {
        ...
        _trigger: function _trigger(i, e, r) {
          var n,
            o = !1;
          return (
            (r = [this].concat(r || [])),
        ...
        (t.fn[s] = function(i) {
          ...
          return (
            "string" == typeof i
              ...
              : this.each(function() {
                  var e = t(this).data(s);
                  _instanceof(e, r) ? e.reload(i) : new r(this, i);
                }),
            n
          );
        }),
  ...
  (function(t, i) {
    ...
    t.jCarousel.plugin("jcarousel", {
          ...
          if (r.target > 0) {
            ...
            if (v >= d && this.tail)
              ...
              (this.underflow &&
                ...
                (!this.underflow && v === d && ("both" === p || "last" === p)))
            )
              this._scroll(0, s, e);
      ...
      _scroll: function _scroll(i, s, e) {
        if (this.animating) return t.isFunction(e) && e.call(this, !1), this;
        if (
          ("object" != _typeof(i)
            ? (i = this.items().eq(i))
            : i.jquery === void 0 && (i = t(i)),
          0 === i.length)
        )
      ...
      _scrollTail: function _scrollTail(i, s) {
      ...
      _animate: function _animate(i, s, e) {
      ...
      _prepare: function _prepare(i) {
        ...
        return (
          ...
          f ||
            ...
            ((h -= s(d.last.css("margin-" + c))), h > u && (this.tail = h - u)),
          this
        );
      },
