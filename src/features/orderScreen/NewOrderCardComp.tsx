...
const NewOCardComp = ({ item,handleSubmit}: { item: any,handleSubmit:any}) => {
    return ( <>
                ...
                <Card >
                    <Card.Body>
                        <Row>
                            ...
                            <h1 style={{fontSize:"12px",fontWeight:660,marginTop:"10px",marginLeft:"7px"}}>Address: <span style={{fontSize:"12px",fontWeight:455,color:"grey"}}>{item['shopDetails'].address}, {item['shopDetails'].city}, {item['shopDetails'].state}, {item['shopDetails'].country} {item['shopDetails'].pin}</span></h1>
                            <hr/>
                            <Row>
                                <Col xs={12}>
                            ...
                            <Row>
                                <Col xs={12} md={6}>
                                    ...
                                    <i className="pi pi-check-circle" style={{color:"grey",fontSize:"14px",marginTop:"10px"}}><span style={{fontSize:"11px",color:'grey',margin:"-15px 0px 0px 5px",fontWeight:888,fontFamily:"sans-serif"}}>Accepted</span></i> 
                                </Col>
                                <Col xs={12} md={6} style={{textAlign:"right"}}>
                                    ...
                                    <h1 style={{fontSize:"10px",marginTop:"10px",color:"grey"}}></h1>
                                </Col>
                            </Row>
                            </Col>
                        ...
                        {/*<Row>
                                <Col xs={12} md={6}>
                                    <Button style={{width:"100%",textAlign:"center",display:"block",margin:"0px auto 0px auto",border:"none",backgroundColor:"#c63d3d"}} onClick={()=>{handleSubmit(item["order_Id"],"Rejected")}}>Reject</Button>
                                </Col>
                                <Col xs={12} md={6}>
                                    <Button style={{width:"100%",textAlign:"center",display:"block",margin:"0px auto 0px auto",border:"none",backgroundColor:"#1e5aff"}} onClick={()=>{handleSubmit(item["order_Id"],"Accepted")}}>Accept order</Button>
                                </Col>
                        </Row>*/}
                    </Card.Body>
                </Card>
